...
const PowerBallResults = ({array}) => {
    ...
    function Cells({ items }) {
        return items.map(item => (
            <tr 
                ...
                className="rounded-3xl font-spoqa text-14px tracking-tight text-gray-c8c8c8 h-62px w-full border-b border-gray-252525"
            >
    ...
    return (
        ...
        <table className="w-full">
            <thead className="bg-gray-2e2e2e rounded-3xl font-spoqaMedium text-14px tracking-tight text-gray-ccc2b6 h-56px border-b border-gray-252525">
                <tr>
