...
const SportsGamePolicyTable1 = ({array}) => {
    ...
    const Cell = ({
        ...
        <tr className={`${ruleText2 ? "h-73px" : "h-56px"} bg-gray-323232 font-spoqa text-14px tracking-tight text-gray-c8c8c8  w-full border-b border-gray-252525 pt-px`}>
            ...
            <td style={{width: "792px", WebkitTextStroke:"0.2px"}} className={`${ruleText2 ? "-space-y-4px" : ""} h-56px pl-20px`}>
                <p>{ruleText}</p>
                <p>{ruleText2}</p>
            </td>
        </tr>
  ...
  return (
      <div className="shadow-table w-full overflow-hidden rounded-4px p-px"
        ...
        <table className="w-full bg-gray-323232 rounded-4px overflow-hidden">
            <thead className="bg-gray-2e2e2e font-spoqaMedium text-14px tracking-tight text-gray-ccc2b6 h-55px border-b border-gray-252525 pt-px">
                <tr>
