    ...
    function Cells({ items }) {
        ...
        return items.map((item,index) => (
            <div className={`${
                ...
                <div style={{width: "123px", color: item.profit.includes("+") ? "#e65454" : "#c8c8c8"}} className="font-robotoRegular text-right">{item.profit}</div>
                <div style={{width: "80px", color: item.status === "승" ? "#e65454" : "#c8c8c8"}} className="text-center">{item.status}</div>
