        ...
        <table className="rounded-4px shadow-navbar overflow-hidden">
            ...
            <tbody className="w-full text-585858 text-14px tracking-tight font-spoqa">
                <tr className="font-spoqa text-14px tracking-tight text-gray-c8c8c8 h-56px  border-b border-dark-252525 bg-dark-323232">
                    <td style={{WebkitTextStroke:"0.2px"}} className="w-152px text-center font-robotoRegular">2021-06-30</td>
                    <td style={{WebkitTextStroke:"0.2px"}} className="w-133px text-center">Rolling Bonus</td>
                    <td style={{WebkitTextStroke:"0.2px"}} className="w-129px text-center">louie3</td>
                    <td style={{WebkitTextStroke:"0.2px"}} className="w-136px text-center">스포츠</td>
                    <td style={{WebkitTextStroke:"0.2px"}} className="w-141px text-right pr-14px font-robotoRegular">5,000</td>
                    <td style={{WebkitTextStroke:"0.2px"}} className="w-116px text-center font-robotoRegular">1.00%</td>
                    <td style={{WebkitTextStroke:"0.2px"}} className="w-102px text-center font-robotoRegular">100%</td>
                    <td style={{WebkitTextStroke:"0.2px"}} className="w-133px text-center font-robotoRegular text-blue-r0056a6">50P</td>
                </tr>
