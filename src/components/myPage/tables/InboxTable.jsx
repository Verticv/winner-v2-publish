        ...
        return items.map(item => (
            ...
            >
                <div className="flex items-center font-spoqaBold text-14px tracking-tight text-gray-c8c8c8 h-56px border-b border-dark-252525 px-52px last:border-b-0">        
                    ...
                    <div
                        style={{width:'569px', color: item.isRead === true ? '#a0a0a0' : '#eeeeee' }}
                        className={`${
                            item.isRead === true 
                   ...
                   <div className={`${item.isRead === true ? "text-gray-929292" : "text-gray-c8c8c8"} flex font-spoqa justify-center text-center`} style={{width:'160px', color: item.isRead === true ? '#a0a0a0' : '#eeeeee' }}>{item.time}</div>
