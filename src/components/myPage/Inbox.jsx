    ...
    const InboxSearch = (
        <div className="h-64px w-full bg-gray-2e2e2e rounded-4px flex items-center justify-center space-x-10px">
            ...
            <div className="flex w-381px h-42px bg-dark-1a1a1a rounded-4px border border-gray-404040 relative">
                ...
                />
                <button className="flex items-center justify-center w-42px h-42px rounded-4px bg-gradient-to-b from-gray-a57b51  to-gray-4b3b09 flex-shrink-0  filter hover:brightness-125 shadow-btn absolute right-0 z-10">
                  <div className="flex items-center justify-center w-40px  h-40px rounded-4px bg-gradient-to-b from-gray-e6b786  to-gray-80603f">
