                  ...
                  <div className='h-full w-full bg-dark-323232 pt-40px px-175px'> 
                    <div className="w-full flex flex-col space-y-8px">
                        <div className="flex space-x-10px w-full">
                            <Title text="아이디" />
                            <div className="h-44px w-540px space-y-2 flex items-center flex-shrink-0 text-gray-c8c8c8 rounded-4px" style={{ background: '#191817' }}>
                    ...
                    {/* BREAK */}
                    <div className="w-full flex flex-col space-y-10px mt-39px">
                        <div className="flex space-x-10px w-full">
                            <Title text="비밀번호" />
                            <div className={`${selectedInput === 0 ? "space-y-7px" : "space-y-8px"} w-full h-44px`}>
                                  <input
                                    style={{ background: '#191817' }}                      
                                    className="w-full font-spoqa text-16px outline-none text-gray-r828282 pl-9px placeholder-gray-r828282 h-full rounded-4px" 
                    ...
                    <div className="w-full flex flex-col space-y-10px mt-14px">
                        <div className="flex space-x-10px w-full">
                            <Title text="비밀번호 확인" />
                            <div className={`${selectedInput === 1 ? "space-y-7px" : "space-y-8px"} w-full h-44px`}>
                                <input 
                                    style={{ background: '#191817' }}                      
                                    className="w-full font-spoqa text-16px outline-none text-gray-r828282 pl-9px placeholder-gray-r828282 h-full rounded-4px"  
                    ...
                    {/* BREAK */}
                    <div className="w-full flex flex-col space-y-10px mt-38px">
                        <div className="flex space-x-10px w-full">
                            <Title text="환전 비밀번호" />
                            <div className={`${selectedInput === 2 ? "space-y-7px" : "space-y-8px"} w-full h-44px`}>
                                <input 
                                    style={{ background: '#191817' }}                      
                                    className="w-full font-spoqa text-16px outline-none text-gray-r828282 pl-9px placeholder-gray-r828282 h-full rounded-4px" 
                    ...
                    <div className="w-full flex flex-col space-y-10px mt-14px">
                        <div className="flex space-x-10px w-full">
                            <Title text="환전 비밀번호" />
                            <div className={`${selectedInput === 3 ? "space-y-7px" : "space-y-8px"} w-full h-44px `}>
                                <input 
                                    style={{ background: '#191817' }}                      
                                    className="w-full font-spoqa text-16px outline-none text-gray-r828282 pl-9px placeholder-gray-r828282 h-full rounded-4px"  
                    ...
                    <div className="w-full space-y-9px mt-38px ">
                        <div className="w-full flex flex-col space-y-8px">
                            <div className="flex space-x-10px w-full">
                                <Title text="레벨" />
                                <div className="h-44px w-540px space-y-2 flex items-center flex-shrink-0 text-gray-c8c8c8 rounded-4px" style={{ background: '#191817' }}>
                                    <label className="font-spoqa text-16px pl-10px ">레벨 LV.1 (점수: 0)</label>
                                    {/* <div className="border-b w-full border-gray-bebebe"></div> */}
                                </div>
                            </div>
                        </div>
