...
const LiveCasinoHistoryDetailPopup = ({setPopupOpen}) => {
    return (
        <div 
            style={{ height: "793px", width: "690px", borderRadius: "10px", backgroundColor: 'rgb(50, 50, 49)', boxShadow: '3.5px 6.062px 7px 0px rgba(0, 0, 0, 0.75)' ,borderWidth:'1px', borderColor:'#1f1f1e'}}
            className="bg-white overflow-hidden"
        >
          
            <div className="relative h-65px bg-gray-272726 flex items-center justify-center flex-shrink-0">
            ...
            <div style={{}} className="h-full bg-gray-323231 flex flex-col items-center text-yellow-ad9e8c">
                ...
                <div 
                    style={{width:"618px", height:"619px", border:'2px solid #473e35',boxShadow: '0px 1px 4px 0px rgba(0, 0, 0, 0.5)'}} 
                ...
                >
                    ...
                    <div className="flex flex-col">
                        <div 
                            ...
                            className="h-42px flex items-center justify-center text-16px font-spoqaMedium tracking-tight text-golden-highLight overflow-hidden"
                        >
                        ...
                        <div className="flex">
                            ...
                            >
                                ...
                                <div 
                                    style={{backgroundColor:"#473e35"}}
                                    className="h-42px flex items-center justify-center text-16px font-spoqaMedium tracking-tight text-golden-highLight"
                                >
                                    뱅커 핸드
                                </div>
                                ...
                                <div style={{height:"42px"}} className="flex h-41px border-b border-dark-252525">
                                    <div 
                            ...
                            >
                                ...
                                <div style={{height:"41px"}}  className="flex">
                                    <div 
                                        style={{backgroundColor:"#473e35"}}
                                ...
                                <div style={{height:"42px"}} className="flex font-robotoRegular text-gray-c8c8c8">
                                    <div 
                                        style={{}}
