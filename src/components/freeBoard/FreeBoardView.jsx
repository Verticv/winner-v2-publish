                    ...
                    <div className="flex self-start items-start space-x-4px justify-end">
                        ...
                        <button className="flex items-center justify-center w-90px h-36px p-px rounded-4px  shadow-link hover:filter hover:brightness-125"
                          style={{ background: 'linear-gradient(to top, #4b3b09, #e8b888)'}}>
                            <div className="flex items-center justify-center h-34px w-88px rounded-4px cursor-pointer"
            ...
            <div className="pl-48px">
                <div className="w-full rounded-4px bg-gray-252525 flex items-start px-20px  pt-17px pb-14px justify-between text-gray-c8c8c8 mt-px">
                    <div className="text-14px font-spoqa tracking-tight ">
                        {tag && (<span className={`text-blue-2980b9 mr-10px font-spoqaMedium`}>@{tag.length > 8 ? tag.substring(0, 8) : tag} {tag.length > 8 && (<span className='-mt-5px inline-block'>...</span>)}</span>)}
                        <span className=" text-gray-c8c8c8">{text}</span>
                    </div>
                    <p className="text-gray-c8c8c8  tracking-tight font-spoqa text-14px flex flex-shrink-0 ml-7px">2021.06.28 15:36</p>
                </div>
            </div>
        </div>
    )
          ...
          >
            <div  className="w-full bg-gray-323232 rounded-4px overflow-hidden">
                  <div className="bg-gray-2e2e2e border-b border-gray-252525 flex items-start px-19px py-15px space-x-10px">
                      ...
                      <div className="text-15px font-spoqaMedium tracking-tight text-gray-c8c8c8 mt-2px">메신져 고객센터 사칭주의</div>
                  </div>
            ...
            <div className="shadow-table w-full overflow-hidden rounded-4px p-px"
              ...
              <div  className="w-full bg-gray-323232 rounded-4px pl-18px pr-19px pb-19px">
                  <div className="pt-16px pb-18px flex items-start space-x-9px">
                    ...
                    <div className="w-17px h-17px text-white text-12px font-roboto flex items-center justify-center rounded-4px bg-red-e9441d pt-px flex-shrink-0 mt-2px">2</div>
                  </div>
                ...
                <div className="w-full bg-gray-323232 rounded-4px pb-20px">
                    <div className="border-b border-gray-252525 pl-20px pr-18px"> 
                        ...
                        <div className="rounded-4px bg-gray-252525 w-full  flex items-start px-19px pt-17px pb-14px justify-between text-gray-c8c8c8 mb-10px mt-px">
                            <p className="text-15px font-spoqa tracking-tight pr-7px">두개의 이벤트 모두 참여하였습니다</p>
