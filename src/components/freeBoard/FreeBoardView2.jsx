      ...
      >
        <div className="w-full bg-gray-323232 rounded-4px overflow-hidden">
          ...
          <div className="py-16px w-full border-b border-gray-252525 px-19px flex items-start text-14px font-spoqaMedium tracking-tight text-gray-929292">
            <img src={Rank1} alt="" />
            <p className="ml-3px mt-2px">하이도1207
              <div className="inline-block">
                <div className="inline-block h-10px w-px mx-9px" style={{ background: '#4c4c4c' }}></div>
                <p className="inline-block">2021.06.28 15:49</p>
                <div className="inline-block h-10px w-px mx-9px" style={{ background: '#4c4c4c' }}></div>

                <div className="inline-block font-spoqaMedium text-14px tracking-tight text-gray-929292 mr-9px">댓글</div>
                <div className="inline-block px-5px h-17px text-white text-12px font-roboto items-center justify-center rounded-4px bg-red-e9441d -mt-px">2</div>
              </div>
            </p>
