        ...
        <div className="w-full shadow-table overflow-hidden rounded-4px p-px"
          ...
          <div  className="w-full bg-gray-323232 rounded-4px overflow-hidden p-30px space-y-30px">
            <div className="flex space-x-20px items-start">
                ...
                <div style={{backgroundColor:"#2b2b2a", height:"585px"}} className="w-full h-full rounded-xl p-20px">
                    ...
                    <div className="pt-20px space-y-23px">
                        ...
                        <Item number="0" title="알아두세요!" text='' text2='' color2="※ 스피드게임 : 45초 베팅시간 제공." />
                    </div>
                </div>
            </div>
            ...
            <div className="flex space-x-20px items-start">
              ...
              <div style={{backgroundColor:"#2b2b2a", height:"662px"}} className="w-full h-full rounded-xl p-20px">
                ...
                <div className="pt-20px space-y-23px">
                    <Item title="베팅구역" text="" color1="플레이어, 뱅커, 타이, 플레이어페어, 뱅커페어 등" text2={"각 베팅구역을 누르면 베팅이 가능합니다."} />
            ...
            <div className="flex space-x-20px items-start">
              ...
              <div style={{backgroundColor:"#2b2b2a", height:"442px"}} className="w-full h-full rounded-xl p-20px">
