...
const SignupPopup = ({setAuth, setPopupOpen}) => {
	...
	if (toLogin) return (
		...
		<div style={{height:'886px', width:'850px', borderWidth:'1px', borderColor:'#1f1f1e', backgroundColor:'#323231', borderRadius:'10px'}} className="relative mt-30px shadow-popup flex flex-col items-center">
