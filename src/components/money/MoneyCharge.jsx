    ...
    return (
        <div className="flex flex-col items-center">
          ...
          className="rounded-4px shadow-table overflow-hidden p-px mt-21px w-full ">
            <div className="h-full w-full rounded-3px overflow-hidden bg-gray-323232 p-9px">
              ...
              <button 
                style={{background:'linear-gradient(to top, #3f3d37, #a69685)'}}
                    ...
                    <button 
                        className="flex items-center justify-center h-42px w-75px rounded-2px  hover:brightness-125 filter shadow-link" style={{background:'linear-gradient(to top, #4b3b09, #e8b888)'}}
                        ...
                        <div className="flex space-x-5px w-full h-full flex-col space-y-15px">
                            ...
                            <div className='flex space-x-5px'>
                                <button 
                                    ...
                                    className="flex items-center justify-center h-42px rounded-2px  hover:brightness-125 filter shadow-link" 
                                ...
                                >
                                    <div style={{width: "133px",background: 'linear-gradient(to bottom, #e06446, #96341d)'}} className="flex items-center h-40px rounded-2px cursor-pointer">
            ...
            <button style={{width: "228px",background: 'linear-gradient(to top, #3d4a8d, #88d9e8)'}} className="flex items-center justify-center h-52px rounded-2px  mt-20px hover:brightness-125 filter shadow-link">
